...
(function(factory) {
  ...
  Slick.prototype.autoPlayIterator = function() {
    ...
    if (!_.paused && !_.interrupted && !_.focussed) {
      ...
      if (_.options.infinite === false) {
        ...
        if (_.direction === 1 && (_.currentSlide + 1) === (_.slideCount -
            1)) {
          _.direction = 0;
  ...
  Slick.prototype.buildDots = function() {
    ...
    if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
      ...
      for (i = 0; i <= _.getDotCount(); i += 1) {
        dot.append($('<li />').append(_.options.customPaging.call(this, _,
          i)));
      }
  ...
  Slick.prototype.changeSlide = function(event, dontAnimate) {
    ...
    indexOffset = unevenOffset ? 0 : (_.slideCount - _.currentSlide) % _.options
      .slidesToScroll;

    switch (event.data.message) {

      case 'previous':
        slideOffset = indexOffset === 0 ? _.options.slidesToScroll : _.options
  ...
  Slick.prototype.getDotCount = function() {
    ...
    if (_.options.infinite === true) {
      while (breakPoint < _.slideCount) {
        ...
        counter += _.options.slidesToScroll <= _.options.slidesToShow ? _
          .options.slidesToScroll : _.options.slidesToShow;
      }
  ...
  Slick.prototype.initializeEvents = function() {
    ...
    $(window).on('orientationchange.slick.slick-' + _.instanceUid, $.proxy(
      _.orientationChange, _));
  ...
  Slick.prototype.lazyLoad = function() {
    ...
    if (_.options.centerMode === true) {
      if (_.options.infinite === true) {
        ...
        rangeStart = Math.max(0, _.currentSlide - (_.options.slidesToShow /
          2 + 1));
    ...
    if ($.type(responsiveSettings) === 'array' && responsiveSettings.length) {
      ...
      for (breakpoint in responsiveSettings) {
        ...
        if (responsiveSettings.hasOwnProperty(breakpoint)) {
          ...
          _.breakpointSettings[currentBreakpoint] = responsiveSettings[
            breakpoint].settings;
  ...
  Slick.prototype.setDimensions = function() {
    ...
    if (_.options.vertical === false && _.options.variableWidth === false) {
      ...
      _.$slideTrack.width(Math.ceil((_.slideWidth * _.$slideTrack.children(
        '.slick-slide').length)));
  ...
  Slick.prototype.setProps = function() {
    ...
    if (bodyStyle.MozTransform !== undefined) {
      ...
      if (bodyStyle.perspectiveProperty === undefined && bodyStyle.MozPerspective ===
        undefined) _.animType = false;
    }
  ...
  Slick.prototype.swipeHandler = function(event) {
    ...
    if ((_.options.swipe === false) || ('ontouchend' in document && _.options
        .swipe === false)) {
      return;
    } else if (_.options.draggable === false && event.type.indexOf(
        'mouse') !== -1) {
      return;
    }

    _.touchObject.fingerCount = event.originalEvent && event.originalEvent
      .touches !== undefined ?
  ...
  Slick.prototype.swipeMove = function(event) {
    ...
    _.touchObject.curX = touches !== undefined ? touches[0].pageX : event
      .clientX;
    _.touchObject.curY = touches !== undefined ? touches[0].pageY : event
      .clientY;
    ...
    if (_.options.infinite === false) {
      if ((_.currentSlide === 0 && swipeDirection === 'right') || (_.currentSlide >=
          _.getDotCount() && swipeDirection === 'left')) {
